...
@License :   <>
@Desc    :  Class for handling a Thorlabs ZFS25B with KST101
"""
...
class Z_Stage:
    """
    Class for controlling a Thorlabs Z-stage ZFS25B (linear stage actuator)
    1228800 steps = 1 mm
    """
    def __init__(self) -> None:
        ...
        for e, device in enumerate(connected_devices):
            try:
                ...
                _ = device.index("Stepper Controller")
